...
<div class="container-fluid">
	<div class="row-fluid">
		...
		<div class="well">
			<h1 class="text-info">Rekapitulasi Kurang Setoran</h1>
		</div>
		...
		<div class="well">
			...
			<div id="printArea">
				...
				<div class="reportTitle">
					...
					==============================================
					<p>Laporan Akumulasi KS : <? echo $this->tglAwal.' S/D '.$this->tglAkhir; ?></p>
				</div>

				<p>Total Record : <? echo count($this->listKS); ?></p>
				...
				<tbody>
					...
					<? foreach ($this->listKS as $key => $value) { ?>
						<? 
							$nomor += 1; 
							$target = $target + $value['target'];
							$total = $total + $value['totalsetoran'];
							$ks = $ks + $value['kurangsetoran'];
...
<script type="text/javascript">
	...
	function filterTanggal()
	{
		...
		load('report/filterrekapks/'+awal+'_'+akhir, '#printArea');
	}
